...
[NVIDIA Flex](https://github.com/NVIDIAGameWorks/FleX) ⭐ 811 | 🐛 96 | 🌐 C++ | 📅 2021-04-15 is a particle-based simulation library designed for real-time applications.
...
[OpenVR](https://github.com/ValveSoftware/openvr) ⭐ 6,648 | 🐛 1,043 | 🌐 C++ | 📅 2026-03-27 is an API and runtime that allows access to VR hardware(Steam Index, HTC Vive, and Oculus Rift) from multiple vendors without requiring that applications have specific knowledge of the hardware they are targeting.
...
[Atlas](https://github.com/Netflix/atlas) ⭐ 3,563 | 🐛 8 | 🌐 Scala | 📅 2026-09-03 is an in-memory dimensional [time series database](https://en.wikipedia.org/wiki/Time_series_database).
